...
UIZZE welcomes focused fixes that improve the clarity, portability, or reliability of the `anti-ui-slop` workflow.
...
For product support, use [uizze.com](https://uizze.com).
